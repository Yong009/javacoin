    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h3 hidden><span>자동매매 : </span><span id="auto" ></span></h3>
                <h3 class="mt-4">변동성 돌파 전략 이란?&nbsp;&nbsp;&nbsp;<span>오늘의 목표가(매수가) : &nbsp;</span><span id="todayPrice"></span></h3>
                <p>전날 종가, 최고가, 저가를 이용해서 변동성을 확인 후 그 적정 가격에 구매를 한뒤, 변동이 큰 아침 9시에 파는 전략입니다. </p>
    			<p>리스트를 최소화한 대신 리턴도 적은 전략입니다.</p><br/>
    			<p class="text-red">※access키와 secret키를 잔고 조회 페이지에서 저장 시 자동매매 기능을 사용하실 수 있습니다.※</p><br/>
    			<p class="text-red">※만원 단위로 기입하셔야 하며 0도 다 적어주셔야합니다.!!!!! 아닐 시 자동매매가 안될 수도 있습니다.※</p><br/>
